 ...
 */
const utilGetRunNumberFromModelShopDocumentCode = async (model = null, run_number_field = "run_no", options= {}) => {
...
module.exports = utilGetRunNumberFromModelShopDocumentCode;