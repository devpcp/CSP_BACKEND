const tags = ['ShopPartnerDebtDebitNoteDoc'];
const security = [
    {
        apiKey: []
    }
 ...
 */
const add = {
    description: 'เพิ่มข้อมูล ตารางข้อมูลเอกสารใบเพิ่มหนี้ของเจ้าหนี้การค้า - Partner Debt Debit Note Document (PDN Doc)',
    body: {
        ...
        properties: {
            ...
            bus_partner_id: {
                description: 'รหัสตารางข้อมูลคู่ค้าธุรกิจ',
                type: ['string', 'null'],
                format: 'uuid',
                nullable: true,
                default: null,
            ...
            shop_inventory_import_doc_id: {
                description: 'รหัสหลักตารางข้อมูลใบรับเข้าสินค้า',
                type: ['string', 'null'],
                format: 'uuid',
                nullable: true,
                default: null,
            ...
            shopPartnerDebtDebitNoteLists: {
                ...
                items: {
                    ...
                    properties: {
                        ...
                        shop_inventory_import_doc_id: {
                            description: 'รหัสหลักตารางข้อมูลเอกสารใบรับเข้าสินค้า',
                            type: ['string', 'null'],
                            format: 'uuid',
                            allowNull: true,
                            default: null
                        ...
                        shop_inventory_import_list_id: {
                            description: 'รหัสหลักตารางข้อมูลรายการใบรับเข้าสินค้า',
                            type: ['string', 'null'],
                            format: 'uuid',
                            allowNull: true,
                            default: null
 ...
 */
const all = {
    description: 'แสดงข้อมูล และค้นหาข้อมูล ตารางข้อมูลเอกสารใบเพิ่มหนี้ของเจ้าหนี้การค้า - Partner Debt Debit Note Document (PDN Doc)',
    querystring: {
        type: 'object',
        additionalProperties: false,
        properties: {
            ...
            filter__unUsed__shop_customer_debt_dn_doc_id: {
                description: "แสดงเอกสารเอกสารใบเพิ่มหนี้ของเจ้าหนี้การค้า ที่ยังไม่ได้ถูกใช้งานในใบชำระเจ้าหนี้",
                type: "boolean",
                nullable: false,
                default: false
            }
...
/**
 * A swagger and fastify validator schema for
 * Route [GET] => /api/shopPartnerDebtCreditNoteDoc/byId/:id
 */
const byId = {
    description: 'แสดงข้อมูลตารางข้อมูลเอกสารใบเพิ่มหนี้ของเจ้าหนี้การค้า - Partner Debt Debit Note Document (PDN Doc) แบบระบุรหัสหลักตารางข้อมูล (Id)',
    params: {
        required: ['id'],
        type: 'object',
        properties: {
 ...
 */
const put = {
    description: 'แก้ไขข้อมูลตารางข้อมูลเอกสารใบเพิ่มหนี้ของเจ้าหนี้การค้า - Partner Debt Debit Note Document (PDN Doc) แบบระบุรหัสหลักตารางข้อมูล (Id) \n- โดยสามรถเลือกใส่เฉพาะข้อมูลบางส่วนที่จะแก้ไขได้',
    params: {
        required: ['id'],
        type: 'object',
        properties: {
...
/**
 * A swagger and fastify validator schema for
 * Route [DELETE] => /api/shopPartnerDebtCreditNoteDoc/delete/:id
 */
const del = {
    description: 'ลบข้อมูลตารางข้อมูลเอกสารใบเพิ่มหนี้ของเจ้าหนี้การค้า - Partner Debt Debit Note Document (PDN Doc) แบบระบุรหัสหลักตารางข้อมูล (Id)',
    params: {
        required: ['id'],
        type: 'object',
        properties: {
