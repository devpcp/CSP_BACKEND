 ...
 */
const ShopCustomerDebtCreditNoteListT2 = (table_name) => {
    ...
    class ShopCustomerDebtCreditNoteListT2 extends Model {
        static async createOrUpdateShopCustomerDebtCreditNote_Lists(shopId = null, userId = null, shop_customer_debt_cn_doc_id = null, shopCustomerDebtCreditNoteLists = null, options = {}) {
             ...
             *  currentData: ShopCustomerDebtCreditNoteListT2;
             * }[]};
             */
            ...
            if (options?.isCancelStatus_Doc === true) {
                const findShopCustomerDebtCreditNoteList = await ShopCustomerDebtCreditNoteListT2.findAll({
                    where: {
            ...
            // Cancel unused ShopCustomerDebtCreditNoteListT2
            /**
             * @type {string[]}
             */
            ...
            if (Object.keys(whereQuery).length > 0) {
                ...
                const findUnusedShopCustomerDebtCreditNoteList = await ShopCustomerDebtCreditNoteListT2.findAll({
                    where: whereQuery,
                    transaction: transaction,
                    ShopModels: ShopModels
                });
            ...
            // Edit or Create ShopCustomerDebtCreditNoteListT2
            for (let index = 0; index < shopCustomerDebtCreditNoteLists.length; index++) {
                ...
                if (!isUUID(shopCustomerDebtCreditNoteList.id)) { // สร้างรายการ
                    ...
                    const createdShopCustomerDebtList = await ShopCustomerDebtCreditNoteListT2.create(
                        objToCreate,
                        {
                            validate: true,
                            transaction: transaction,
                     ...
                     */
                    const findShopCustomerDebtCreditNoteList = await ShopCustomerDebtCreditNoteListT2.findOne({
                        where: {
    ...
    ShopCustomerDebtCreditNoteListT2.init(
        {
            id: {
        ...
        {
            sequelize: db,
            modelName: 'ShopCustomerDebtCreditNoteListT2',
            tableName: `dat_${table_name}_customer_debt_cn_list_t2`,
            schema: 'app_shops_datas',
            timestamps: false,
            comment: 'ตารางข้อมูลรายการใบลดหนี้ของลูกหนี้การค้า',
            indexes: [
                {
                    name: `idx_${table_name}_ccn_list_debt_cn_doc_id_t2`,
                    fields: ['shop_customer_debt_cn_doc_id']
                },
                {
                    name: `idx_${table_name}_ccn_list_tmp_doc_id_t2`,
                    fields: ['shop_temporary_delivery_order_doc_id']
                },
                {
                    name: `idx_${table_name}_ccn_list_tmp_list_id_t2`,
                    fields: ['shop_temporary_delivery_order_list_id']
                },
                {
                    name: `idx_${table_name}_ccn_list_product_id_t2`,
                    fields: ['product_id']
                },
                {
                    name: `idx_${table_name}_ccn_list_shop_product_id_t2`,
                    fields: ['shop_product_id']
                },
                {
                    name: `idx_${table_name}_ccn_list_list_id_t2`,
                    fields: ['list_id']
                },
                {
                    name: `idx_${table_name}_ccn_list_list_name_t2`,
                    fields: ['list_name']
                }
            ]
        }
    ...
    ShopCustomerDebtCreditNoteListT2.belongsTo(ShopProfile, { foreignKey: 'shop_id', as: 'ShopsProfile' });
    ShopCustomerDebtCreditNoteListT2.belongsTo(ShopCustomerDebtCreditNoteDocT2, { foreignKey: 'shop_customer_debt_cn_doc_id', as: 'ShopCustomerDebtCreditNoteDoc' });
    ShopCustomerDebtCreditNoteListT2.belongsTo(ShopTemporaryDeliveryOrderDoc, { foreignKey: 'shop_temporary_delivery_order_doc_id', as: 'ShopTemporaryDeliveryOrderDoc' });
    ShopCustomerDebtCreditNoteListT2.belongsTo(ShopTemporaryDeliveryOrderList, { foreignKey: 'shop_temporary_delivery_order_list_id', as: 'ShopTemporaryDeliveryOrderList' });
    ShopCustomerDebtCreditNoteListT2.belongsTo(Product, { foreignKey: 'product_id', as: 'Product' });
    ShopCustomerDebtCreditNoteListT2.belongsTo(ShopProduct, { foreignKey: 'shop_product_id', as: 'ShopProduct' });
    ShopCustomerDebtCreditNoteListT2.belongsTo(User, { foreignKey: 'created_by', as: 'CreatedBy' });
    ShopCustomerDebtCreditNoteListT2.belongsTo(User, { foreignKey: 'updated_by', as: 'UpdatedBy' });
    ...
    const hookFunctions = (options = {}) => {
         ...
         * @param {ShopCustomerDebtCreditNoteListT2} instance
         * @param {import("sequelize/types/model").UpdateOptions<ShopCustomerDebtCreditNoteListT2> | import("sequelize/types/model").SaveOptions<ShopCustomerDebtCreditNoteListT2>} options
         */
        ...
        /**
         * @param {ShopCustomerDebtCreditNoteListT2} instance
         * @param {(import("sequelize/types/model").UpdateOptions<ShopCustomerDebtCreditNoteListT2> | import("sequelize/types/model").SaveOptions<ShopCustomerDebtCreditNoteListT2>) & { isCancelStatus_Doc?: boolean }} options
         */
    ...
    ShopCustomerDebtCreditNoteListT2.beforeValidate(async (instance, options) => {
        instance.myHookFunctions = hookFunctions({ ShopModels: options?.ShopModels });
    });

    ShopCustomerDebtCreditNoteListT2.beforeSave(async (instance, options) => {
    ...
    return ShopCustomerDebtCreditNoteListT2;
};


module.exports = ShopCustomerDebtCreditNoteListT2;