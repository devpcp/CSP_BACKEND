const tags = ['ShopCustomerDebtDebitNoteDoc'];
const security = [
    {
        apiKey: []
    }
 ...
 */
const add = {
    description: 'เพิ่มข้อมูล ตารางข้อมูลเอกสารใบเพิ่มหนี้ของลูกหนี้การค้า - Customer Debt Debit Note Document (CDN Doc)',
    body: {
 ...
 */
const all = {
    description: 'แสดงข้อมูล และค้นหาข้อมูล ตารางข้อมูลเอกสารใบเพิ่มหนี้ของลูกหนี้การค้า - Customer Debt Debit Note Document (CDN Doc)',
    querystring: {
        type: 'object',
        additionalProperties: false,
        properties: {
            ...
            filter__unUsed__shop_customer_debt_dn_doc_id: {
                description: "แสดงเอกสารเอกสารใบเพิ่มหนี้ของลูกหนี้การค้า ที่ยังไม่ได้ถูกใช้งานในใบชำระลูกหนี้",
                type: "boolean",
                nullable: false,
                default: false
            }
 ...
 */
const byId = {
    description: 'แสดงข้อมูลตารางข้อมูลเอกสารใบเพิ่มหนี้ของลูกหนี้การค้า - Customer Debt Debit Note Document (CDN Doc) แบบระบุรหัสหลักตารางข้อมูล (Id)',
    params: {
        required: ['id'],
        type: 'object',
        properties: {
 ...
 */
const put = {
    description: 'แก้ไขข้อมูลตารางข้อมูลเอกสารใบเพิ่มหนี้ของลูกหนี้การค้า - Customer Debt Debit Note Document (CDN Doc) แบบระบุรหัสหลักตารางข้อมูล (Id) \n- โดยสามรถเลือกใส่เฉพาะข้อมูลบางส่วนที่จะแก้ไขได้',
    params: {
        required: ['id'],
        type: 'object',
        properties: {
...
/**
 * A swagger and fastify validator schema for
 * Route [DELETE] => /api/shopCustomerDebtDebitNoteDoc/delete/:id
 */
const del = {
    description: 'ลบข้อมูลตารางข้อมูลเอกสารใบเพิ่มหนี้ของลูกหนี้การค้า - Customer Debt Debit Note Document (CDN Doc) แบบระบุรหัสหลักตารางข้อมูล (Id)',
    params: {
        required: ['id'],
        type: 'object',
        properties: {
