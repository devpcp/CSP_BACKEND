const add = {
    description: 'เพิ่มข้อมูล ในตารางข้อมูลยี่ห้อยานพาหนะ',
    body: {
        type: 'object',
        ...
        properties: {
            internal_code_id: {
                description: 'รหัสหลักตารางข้อมูลยี่ห้อยานพาหนะ (ภายใน)',
                type: 'string',
                default: null,
                example: null
            },
...
const all = {
    description: 'แสดงข้อมูล และค้นหาข้อมูล ในตารางข้อมูลยี่ห้อยานพาหนะ',
    querystring: {
        type: 'object',
        additionalProperties: false,
        properties: {
...
const byid = {
    description: 'แสดงข้อมูล ในตารางข้อมูลยี่ห้อยานพาหนะ แบบระบุรหัสหลักตารางรางข้อมูล (Id)',
    params: {
        required: ['id'],
        type: 'object',
        properties: {
...
const put = {
    description: 'แก้ไขข้อมูล ในตารางข้อมูลยี่ห้อยานพาหนะ แบบระบุรหัสหลักตารางรางข้อมูล (Id)',
    params: {
        required: ['id'],
        type: 'object',
        properties: {
    ...
    body: {
        ...
        properties: {
            ...
            brand_name: {
                ...add.body.properties.brand_name,
                nullable: true,
                default: undefined
            },
            status: {
