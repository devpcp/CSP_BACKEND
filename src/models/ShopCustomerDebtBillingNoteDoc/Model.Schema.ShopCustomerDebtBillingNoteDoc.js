const tags = ['ShopCustomerDebtBillingNoteDoc'];
const security = [
    {
        apiKey: []
    }
 ...
 */
const add = {
    description: 'เพิ่มข้อมูล ตารางข้อมูลเอกสารใบวางบิลลูกหนี้ของลูกหนี้การค้า - Customer Debt Billing Note Document (CBN Doc)',
    body: {
                ...
                items: {
                    ...
                    properties: {
                        ...
                        shop_customer_debt_cn_doc_id_t2: {
                            description: 'รหัสหลักตารางข้อมูลเอกสารใบลดหนี้ของลูกหนี้การค้า ไมคิดภาษี',
                            type: ['string', 'null'],
                            format: 'uuid',
                            allowNull: true
                        },
 ...
 */
const all = {
    description: 'แสดงข้อมูล และค้นหาข้อมูล ตารางข้อมูลเอกสารใบวางบิลลูกหนี้ของลูกหนี้การค้า - Customer Debt Billing Note Document (CBN Doc)',
    querystring: {
        type: 'object',
        additionalProperties: false,
        properties: {
...
/**
 * A swagger and fastify validator schema for
 * Route [GET] => /api/shopCustomerDebtBillingNoteDoc/byId/:id
 */
const byId = {
    description: 'แสดงข้อมูลตารางข้อมูลเอกสารใบวางบิลลูกหนี้ของลูกหนี้การค้า - Customer Debt Billing Note Document (CBN Doc) แบบระบุรหัสหลักตารางข้อมูล (Id)',
    params: {
        required: ['id'],
        type: 'object',
        properties: {
...
/**
 * A swagger and fastify validator schema for
 * Route [PUT] => /api/shopCustomerDebtBillingNoteDoc/put/:id
 */
const put = {
    description: 'แก้ไขข้อมูลตารางข้อมูลเอกสารใบวางบิลลูกหนี้ของลูกหนี้การค้า - Customer Debt Billing Note Document (CBN Doc) แบบระบุรหัสหลักตารางข้อมูล (Id) \n- โดยสามรถเลือกใส่เฉพาะข้อมูลบางส่วนที่จะแก้ไขได้',
    params: {
        required: ['id'],
        type: 'object',
        properties: {
...
/**
 * A swagger and fastify validator schema for
 * Route [DELETE] => /api/shopCustomerDebtBillingNoteDoc/delete/:id
 */
const del = {
    description: 'ลบข้อมูลตารางข้อมูลเอกสารใบวางบิลลูกหนี้ของลูกหนี้การค้า - Customer Debt Billing Note Document (CBN Doc) แบบระบุรหัสหลักตารางข้อมูล (Id)',
    params: {
        required: ['id'],
        type: 'object',
        properties: {
