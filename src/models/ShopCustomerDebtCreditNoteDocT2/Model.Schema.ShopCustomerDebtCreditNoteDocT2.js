const tags = ['ShopCustomerDebtCreditNoteDocT2'];
const security = [
    {
        apiKey: []
    }
 ...
 * Route [POST] => /api/shopCustomerDebtCreditNoteDocT2/add
 */
const add = {
...
/**
 * A swagger and fastify validator schema for
 * Route [GET] => /api/shopCustomerDebtCreditNoteDocT2/all
 */
const all = {
...
/**
 * A swagger and fastify validator schema for
 * Route [GET] => /api/shopCustomerDebtCreditNoteDocT2/byId/:id
 */
const byId = {
...
/**
 * A swagger and fastify validator schema for
 * Route [PUT] => /api/shopCustomerDebtCreditNoteDocT2/put/:id
 */
const put = {
...
/**
 * A swagger and fastify validator schema for
 * Route [DELETE] => /api/shopCustomerDebtCreditNoteDocT2/delete/:id
 */
const del = {
