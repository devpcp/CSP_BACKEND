 ...
 * Route [POST] => /api/shopPartnerDebtDoc/add
 */
const add = {
    description: 'เพิ่มข้อมูล ตารางข้อมูลเอกสารเจ้าหนี้การค้า - Partner Debt Document (CDD Doc)',
    body: {
        ...
        properties: {
            ...
            bus_partner_id: {
                description: 'รหัสตารางข้อมูลผู้จำหน่าย',
                type: ['string', 'null'],
                format: 'uuid',
                nullable: true,
                default: null,
 ...
 */
const all = {
    description: 'แสดงข้อมูล และค้นหาข้อมูล ตารางข้อมูลเอกสารเจ้าหนี้การค้า - Partner Debt Document (CDD Doc)',
    querystring: {
        type: 'object',
        additionalProperties: false,
        properties: {
 ...
 */
const byId = {
    description: 'แสดงข้อมูลตารางข้อมูลเอกสารเจ้าหนี้การค้า - Partner Debt Document (CDD Doc) แบบระบุรหัสหลักตารางข้อมูล (Id)',
    params: {
        required: ['id'],
        type: 'object',
        properties: {
...
/**
 * A swagger and fastify validator schema for
 * Route [PUT] => /api/shopPartnerDebtDoc/put/:id
 */
const put = {
    description: 'แก้ไขข้อมูลตารางข้อมูลเอกสารเจ้าหนี้การค้า - Partner Debt Document (CDD Doc) แบบระบุรหัสหลักตารางข้อมูล (Id) \n- โดยสามรถเลือกใส่เฉพาะข้อมูลบางส่วนที่จะแก้ไขได้',
    params: {
        required: ['id'],
        type: 'object',
        properties: {
...
/**
 * A swagger and fastify validator schema for
 * Route [DELETE] => /api/shopPartnerDebtDoc/delete/:id
 */
const del = {
    description: 'ลบข้อมูลตารางข้อมูลเอกสารเจ้าหนี้การค้า - Partner Debt Document (CDD Doc) แบบระบุรหัสหลักตารางข้อมูล (Id)',
    params: {
        required: ['id'],
        type: 'object',
        properties: {
