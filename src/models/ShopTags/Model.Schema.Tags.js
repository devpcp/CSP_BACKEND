const add = {
    ...
    body: {
        ...
        properties: {
            ...
            details: {
                description: 'รายละเอียดข้อมูลใน tag ShopTags',
                type: 'object',
            ...
            tag_type: {
                description: 'ประเภทของ ShopTags\n0=ใช้ได้ทั้งหมด\n 1=สินค้า\n 2=ลูกค้า',
                type: 'number',
                default: 0,
                example: 0,
                enum: [0, 1, 2]
...
const all = {
    description: 'แสดงข้อมูล และค้นหาข้อมูล ในตารางข้อมูล ShopTags',
    querystring: {
        type: 'object',
        additionalProperties: false,
        properties: {
            ...
            tag_type: {
                ...
                description: `สถานะประเภทของ ShopTags \n- default = ไม่สนใจ \n-0 = ใช้ได้ทั้งหมด\n-1 = สินค้า\n-2 = ลูกค้า`,
            },
            status: {
                default: undefined,
                type: 'string',
