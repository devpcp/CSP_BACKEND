...
const migrate_ReBuild_CodeId_ShopSalesTransactionDoc = async ({ transaction }) => {
            ...
            await xSequelize.query(
                ...
                DO $$
                    ...
                    BEGIN
                        ...
                        LOOP
                            EXECUTE '
                            UPDATE app_shops_datas.dat_'||lower(FFF.shop_code_id)||'_sales_transaction_doc AS z
                            SET code_id = (
                            SELECT REPLACE(x.code_id, y.code_id, y.internal_code_id)
                                FROM app_shops_datas.dat_'||lower(FFF.shop_code_id)||'_sales_transaction_doc AS x
...
module.exports = migrate_ReBuild_CodeId_ShopSalesTransactionDoc;
