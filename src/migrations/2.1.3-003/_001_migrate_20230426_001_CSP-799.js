...
const _001_migrate_20230426_001_CSP_799 = async ({ transaction }) => {
    ...
    const modelShopBusinessPartners = require("../../models/ShopBusinessPartners/ShopBusinessPartners");
    ...
    const transactionResults = await xSequelize.transaction(
        ...
        async (transaction) => {
            ...
            for (let index = 0; index < shop_code_ids.length; index++) {
                ...
                const instanceModelShopBusinessPartners = modelShopBusinessPartners(element_shop_code_id);
                await instanceModelShopBusinessPartners.sync({
                    alter: {
                        drop: false
                    },
                    transaction: transaction
...
module.exports = _001_migrate_20230426_001_CSP_799;

// _001_migrate_20230426_001_CSP_799({ transaction: null });