 ...
 */
const handlerShopCustomerDebtCreditNoteDocById = async (request = {}, reply = {}, options = {}) => {
    const action = 'GET ShopCustomerDebtCreditNoteDocT2.ById';
...
module.exports = handlerShopCustomerDebtCreditNoteDocById;