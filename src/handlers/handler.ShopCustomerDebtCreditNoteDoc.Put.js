 ...
 */
const handlerShopCustomerDebtCreditNoteDocPut = async (request = {}, reply = {}, options = {}) => {
    const action = 'PUT ShopCustomerDebtCreditNoteDoc.Put';
        ...
        if (!findShopCustomerDebtCreditNoteDoc) {
            ...
            const transactionResult = await db.transaction(
                ...
                async (transaction) => {
                    ...
                    const created_and_updated_doc_lists = await ShopCustomerDebtCreditNoteDoc.createOrUpdateShopCustomerDebtCreditNote_Doc_Lists(
                        findShopCustomerDebtCreditNoteDoc.get('shop_id'),
                        request.id,
                        { id: findShopCustomerDebtCreditNoteDoc.get('id'), ...request.body },
                        request.body?.shopCustomerDebtCreditNoteLists || [],
                        {
...
module.exports = handlerShopCustomerDebtCreditNoteDocPut;