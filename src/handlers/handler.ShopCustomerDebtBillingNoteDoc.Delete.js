...
/**
 * - Route [DELETE] => /api/shopCustomerDebtBillingNoteDoc/delete
 * @template T
 ...
 */
const handlerShopCustomerDebtBillingNoteDocDelete = async (request = {}, reply = {}, options = {}) => {
    const action = 'DELETE ShopCustomerDebtBillingNoteDoc.Delete';
    ...
    try {
        ...
        const transactionResult = await db.transaction(
            ...
            async (transaction) => {
                ...
                const findShopCustomerDebtDoc = await ShopCustomerDebtBillingNoteDoc.findOne({
                    where: {
                ...
                if (!findShopCustomerDebtDoc) {
                    ...
                    const canceledDocument = await ShopCustomerDebtBillingNoteDoc.updateShopCustomerDebtBillingNote_Doc(
                        findShopCustomerDebtDoc.get('shop_id'),
                        request.id,
                        {
                            id: findShopCustomerDebtDoc.get('id'),
                            status: 2
                        },
                        {
                            ...options,
...
module.exports = handlerShopCustomerDebtBillingNoteDocDelete;