...
/**
 * - Route [PUT] => /api/shopPartnerDebtDebitNoteDoc/put/:id
 * @template T
 ...
 */
const handlerShopPartnerDebtDebitNoteDocPut = async (request = {}, reply = {}, options = {}) => {
    const action = 'PUT ShopPartnerDebtDebitNoteDoc.Put';
        ...
        if (!findShopPartnerDebtDebitNoteDoc) {
            ...
            const transactionResult = await db.transaction(
                ...
                async (transaction) => {
                    ...
                    const created_and_updated_doc_lists = await ShopPartnerDebtDebitNoteDoc.createOrUpdateShopPartnerDebtDebitNote_Doc_Lists(
                        findShopPartnerDebtDebitNoteDoc.get('shop_id'),
                        request.id,
                        { id: findShopPartnerDebtDebitNoteDoc.get('id'), ...request.body },
                        request.body?.shopPartnerDebtDebitNoteLists || [],
                        {
...
module.exports = handlerShopPartnerDebtDebitNoteDocPut;