 ...
 */
const handlerShopTemporaryDeliveryOrderDocAll = async (request = {}, reply = {}, options = {}) => {
    const action = 'GET ShopTemporaryDeliveryOrderDoc.All';
    ...
    try {
        ...
        const is_draft = request.query?.is_draft || 'default';
        ...
        const findDocument = await ShopTemporaryDeliveryOrderDoc.findAll({
            attributes: {
                include: [
                    [literal(`(SELECT user_name FROM systems.sysm_users WHERE id = "ShopTemporaryDeliveryOrderDoc"."created_by" )`), 'created_by'],
                    [literal(`(SELECT user_name FROM systems.sysm_users WHERE id = "ShopTemporaryDeliveryOrderDoc"."updated_by" )`), 'updated_by'],
                ]
            },
...
module.exports = handlerShopTemporaryDeliveryOrderDocAll;