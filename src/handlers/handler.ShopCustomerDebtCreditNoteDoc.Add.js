...
const handlerShopCustomerDebtCreditNoteDocAdd = async (request = {}, reply = {}, options = {}) => {
    const action = 'POST ShopCustomerDebtCreditNoteDoc.Add';
    ...
    try {
         ...
         * @type {
         * {
         *  ShopCustomerDebtCreditNoteDoc: {isCreated: boolean, isUpdated: boolean, currentData: ShopCustomerDebtCreditNoteDoc, previousData: null};
         *  ShopCustomerDebtCreditNoteLists: {isCreated: boolean, isUpdated: boolean, previousData: null, currentData: ShopCustomerDebtCreditNoteList}[];}
         * }
         */
        const transactionResult = await db.transaction(
            ...
            async (transaction) => {
                ...
                const createdDocAndLists = await ShopCustomerDebtCreditNoteDoc.createOrUpdateShopCustomerDebtCreditNote_Doc_Lists(
                    table_shop_id,
                    request.id,
        ...
        await handleSaveLog(request, [[action, transactionResult.ShopCustomerDebtCreditNoteDoc.currentData.get('id'), request.body, transactionResult.ShopCustomerDebtCreditNoteDoc], '']);
