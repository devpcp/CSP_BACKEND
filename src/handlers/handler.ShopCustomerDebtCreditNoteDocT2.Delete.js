...
const handlerShopCustomerDebtCreditNoteDocDelete = async (request = {}, reply = {}, options = {}) => {
    const action = 'DELETE ShopCustomerDebtCreditNoteDocT2.Delete';
        ...
        const transactionResult = await db.transaction(
            ...
            async (transaction) => {
                ...
                if (!findShopCustomerDebtCreditNoteDoc) {
                    ...
                    const canceledDocument = await ShopCustomerDebtCreditNoteDocT2.cancelShopCustomerDebtCreditNote_Doc(
