...
const handlerShopCustomerDebtCreditNoteDocPut = async (request = {}, reply = {}, options = {}) => {
    const action = 'PUT ShopCustomerDebtCreditNoteDocT2.Put';
        ...
        if (!findShopCustomerDebtCreditNoteDoc) {
            ...
            const transactionResult = await db.transaction(
                ...
                async (transaction) => {
                    ...
                    const created_and_updated_doc_lists = await ShopCustomerDebtCreditNoteDocT2.createOrUpdateShopCustomerDebtCreditNote_Doc_Lists(
