 ...
 */
const handlerShopPartnerDebtCreditNoteDocById = async (request = {}, reply = {}, options = {}) => {
    const action = 'GET ShopPartnerDebtCreditNoteDoc.ById';
...
module.exports = handlerShopPartnerDebtCreditNoteDocById;